...
class ChatList extends ConsumerStatefulWidget {
  ...
  const ChatList({Key? key, required this.recieverUserId,
...
class _ChatListState extends ConsumerState<ChatList> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Message>>(
      stream: widget.isGroupChat ? ref.read(chatControllerProvider).groupCharStream(widget.recieverUserId) : ref.read(chatControllerProvider).chatStream(widget.recieverUserId),
