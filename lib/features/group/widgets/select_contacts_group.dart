...
class _SelectContactsGroupState extends ConsumerState<SelectContactsGroup> {
  ...
  Widget build(BuildContext context) {
    return ref.watch(getContactProvider).when(data: (contactList)=> Expanded(child: ListView.builder(
      ...
      return InkWell(
        ...
        child: ListTile( 
          ...
          leading: selectedContactsIndex.contains(index) ? IconButton(onPressed: (){
