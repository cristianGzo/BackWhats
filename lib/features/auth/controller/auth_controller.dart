...
class AuthController{
  ...
  void signInWithPhone(BuildContext context, String phoneNhumber){
    authRepository.signInWithPhone(context, phoneNhumber);
  }
  ...
  void setUserState (bool inOnline) {
    authRepository.setUserState(inOnline);
  }
}