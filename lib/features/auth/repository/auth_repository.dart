...
import 'package:whatsapp_ui/features/auth/repository/user_info.dart';
...
class AuthRepository{
  ...
  void signInWithPhone(BuildContext context, String phoneNhumber) async {
    try{
        await auth.verifyPhoneNumber(phoneNumber: phoneNhumber, verificationCompleted: (PhoneAuthCredential credential) async {
  ...
  void saveUserDataToFirebase({
    ...
    try{
      ...
      String photoUrl='https://w0.peakpx.com/wallpaper/221/949/HD-wallpaper-bob-esponja-mafioso-bob-esponja-gangster-mafioso-meme.jpg';
